@extends('master')
@section('title','Create Ward User')
@section('content')
<div class="maininnersection">
    <!-- Default form register -->
    <form class="text-center" id="wardUserCreate" action="{{route('admin.create.ward.user.process')}}" method="post">
        @csrf
        <p class="titlesection">Create Ward User</p>
...
<div class="submitbtn">
    <button class="submitbutton btn btn-dark btn-block submit_button" data-id="wardUserCreate" type="submit">
        Save
    </button>
</div>

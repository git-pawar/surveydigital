@extends('master')
@section('title','Mobile wise report')
@section('content')
<style>
...
<div class="maininnersection">
    ...
    <form method="get" action="{{route('report.typewise',['type'=>'mobilewise'])}}" id="searchinput">
        <div class="w-100 row mx-0 mt-3">
            <div class="width-80">
                <div class="form-row mb-2" data-validate="mobile required">

                    <input type="search" id="search1" value="{{$searchq??''}}" placeholder="Search mobile" name="searchq"
